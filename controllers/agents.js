...
module.exports.toCallEnded = function (req, res) {
  ...
  var twiml = '<Response><Play>' + process.env.PUBLIC_HOST  + '/sounds/bing-low.wav</Play><Pause length="60"/> <Play>' + process.env.PUBLIC_HOST  + '/sounds/call-terminated.wav</Play> <Redirect/></Response>';
  var escaped_twiml = require('querystring').escape(twiml);
